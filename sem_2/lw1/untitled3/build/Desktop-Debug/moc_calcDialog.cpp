...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CalcDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CalcDialog_t qt_meta_stringdata_CalcDialog = {
    {
        QT_MOC_LITERAL(0, 10),  // "CalcDialog"
...
Q_CONSTINIT static const uint qt_meta_data_CalcDialog[] = {
...
Q_CONSTINIT const QMetaObject CalcDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CalcDialog.offsetsAndSizes,
    qt_meta_data_CalcDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CalcDialog_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CalcDialog, std::true_type>,
        // method 'clicked'
